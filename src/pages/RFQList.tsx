...
const statusConfig: Record<RFQ["status"], { icon: typeof Clock; label: string; variant: "default" | "secondary" | "outline" | "destructive" | "success" | "warning" | "buyer" | "supplier" | "admin" }> = {
